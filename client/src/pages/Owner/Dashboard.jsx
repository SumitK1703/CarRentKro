...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3x1'>
        ...
        <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
            {/* recent booking */}
            <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-1g w-full'>
