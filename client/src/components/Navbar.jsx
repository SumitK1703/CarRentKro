...
function Navbar() {
    ...
    const changeRole=async()=>{
        try{
            // ✅ Correct URL (Matches your server routes)
  ...
  return (
    <div className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative transition-all duration-300 bg-white z-50 ${location.pathname==="/"&&"max-sm:bg-white max-sm:translate-x-0"}`}>
